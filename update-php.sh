...
sudo apt-get install mcrypt php7.2-curl php7.2-gmp php7.2-xml php7.2-zip php7.2-gd php7.2-mysql php7.2-mbstring php7.2-bcmath php7.2-mcrypt php7.2-json php7.2-intl php-gettext  -y > /dev/null 2>&1
